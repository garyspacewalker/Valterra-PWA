...
/**
 * HOW TO ADD MULTI-PARAGRAPH BIOS
 *
 * Option A (recommended): Use an array of strings, one per paragraph:
 *   'oliver-green': [
 *     "Paragraph 1...",
 *     "Paragraph 2...",
 *     "Paragraph 3..."
 *   ]
 *
 * Option B: Use a single string with blank lines between paragraphs:
 *   'oliver-green': "Paragraph 1...\n\nParagraph 2...\n\nParagraph 3..."
 */
const BIO_MAP = {
  'oliver-green': [
  ...
  'dave-newman': ["Jewellery Programme Leader, lecturer and practitionerTshwane University of TechnologyDates Employed	Jan 1998 – PresentEmployment Duration	21 yrs 10 mosTeaches Jewellery Techniques at the University, and practices part time as a jeweller",
  ...
  'chris-van-rensburg': ["My name is Chris Van Rensburg and I have been a Jewellery Manufacturer for 40 years",
  ...
  'lorna-lloyd': ["CEO, Jewellery Council of South Africa",
  ...
  'geraldine-fenn': ["I'm a contemporary jeweller living in Johannesburg, South Africa, where I have a studio and gallery called Tinsel. I studied technology jewellery design in Durban, after graduating in Archaeology at Wits, a few years ago I returned to Wits to do Art History and then a Masters in Fine Art. I participated in several jewellery and art group exhibitions, and two solo exhibitions.",
  ...
  'tai-wong': ["Director, Global Innovation DevelopmentPlatinum Guild International",
...
// Normalize bio entry -> array of paragraphs
    ...
    <ScrollView contentContainerStyle={styles.page}>
      ...
      <View style={styles.card}>
        <View style={styles.topRow}>
          <Text style={styles.name}>{name || 'Judge'}</Text>
        ...
        <View style={styles.section}>
          ...
          {paragraphs.length > 0 ? (
            paragraphs.map((p, idx) => (
              <Text key={idx} style={[styles.p, idx > 0 && { marginTop: 10 }]}>
                {p}
              </Text>
            ))
          ) : (
            <Text style={styles.p}>Bio coming soon.</Text>
          )}
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#fff', padding: 16, borderRadius: 14, marginBottom: 16, ...cardShadow },
  card: { backgroundColor: '#fff', padding: 16, borderRadius: 14, ...cardShadow },
  topRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  closeBtn: { padding: 6, borderRadius: 8, backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e5e7eb' },

  name: { fontSize: 22, fontWeight: '900', color: palette.platinumNavy },
  hero: { width: '100%', height: 320, borderRadius: 12, marginTop: 12, resizeMode: 'cover' },

  section: { marginTop: 16 },
  h2: { fontSize: 18, fontWeight: '800', color: palette.valterraGreen, marginBottom: 6 },
  p: { color: palette.platinumNavy, lineHeight: 22 },
});
